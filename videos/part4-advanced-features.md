...
פרוטוקול פתוח וסטנדרטי שנותן ל-LLMs גישה לכל API חיצוני — בסיסי נתונים, שירותי ענן, כלי עיצוב, תיעוד חי. כל MCP הופך לכלי שהסוכן יכול להפעיל.

### כלי MCP פופולריים

- context7 → תיעוד ספריות חי — פותר hallucinations
